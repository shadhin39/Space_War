...
void Home()
{
	...
	iText(350, 30, "Press SPACE for continue", GLUT_BITMAP_TIMES_ROMAN_24);
	iSetColor(255,0,0);
...
void iSpecialKeyboard(unsigned char key)
{
	...
	else
	{
			...
			musicOn=true;
			PlaySound("music//waf.wav",NULL,SND_LOOP|SND_ASYNC);
		} 
	}
...
int main()
{
	...
	if (musicOn)
	{
		PlaySound("music//men.wav",NULL,SND_LOOP|SND_ASYNC);
	}
